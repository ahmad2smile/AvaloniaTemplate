...
public class ArgsProcessor
{
	...
	/// <summary>Builds Avalonia Template binaries for supported platforms to be compared then with the official binaries, and terminates.</summary>
	/// <seealso href="https://github.com/zkSNACKs/AvaloniaTemplate/blob/master/AvaloniaTemplate.Documentation/Guides/DeterministicBuildGuide.md"/>
