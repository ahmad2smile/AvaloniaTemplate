...
Read-Host -Prompt 'Releasing Avalonia Template - Insert a pendrive to store macOS notarization candidate files [Press ENTER]'
Read-Host -Prompt 'Start Kleopatra!'

cd $env:userprofile\desktop/AvaloniaTemplate/AvaloniaTemplate.Packager
dotnet run -- publish
...
$arguments = $env:userprofile + '\Desktop\AvaloniaTemplate\AvaloniaTemplate.WindowsInstaller\AvaloniaTemplate.WindowsInstaller.wixproj /Build "Release|x64"'
