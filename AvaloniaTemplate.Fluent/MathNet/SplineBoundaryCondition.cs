// Copyright (c) 2009-2010 Math.NET Taken from http://github.com/mathnet/mathnet-numerics and modified for Avalonia Template

namespace AvaloniaTemplate.Fluent.MathNet;
