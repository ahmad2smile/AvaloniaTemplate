...
namespace AvaloniaTemplate.Fluent.Generators;

[Generator]
public class NavigationMetaDataGenerator : ISourceGenerator
{
	private const string NavigationMetaDataAttributeDisplayString = "AvaloniaTemplate.Fluent.NavigationMetaDataAttribute";

	private const string NavigationMetaDataDisplayString = "AvaloniaTemplate.Fluent.NavigationMetaData";

	private const string RoutableViewModelDisplayString = "AvaloniaTemplate.Fluent.ViewModels.Navigation.RoutableViewModel";
