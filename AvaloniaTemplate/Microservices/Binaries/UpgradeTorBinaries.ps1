# Script downloads Tor Browsers, then extracts the downloaded archives and copies Tor binaries to "temp/<version>/Tor/<os-platform>" folders to be consumed by Avalonia Template.
...
#   Then the Tor binaries used by Avalonia Template are replaced with the just extracted ones.
